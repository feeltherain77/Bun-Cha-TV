...
# Cấu hình Logo và Nhóm tự động cho Mạnh
SPORTS_CONFIG = {
    "Bóng đá": {"logo": "https://nha-cai.com/wp-content/uploads/2023/11/qua-bong-da.jpg", "keywords": ["bóng đá", "vđqg", "league", "united", "fc", "vs", "u23", "mancity", "real", "cup"]},
    "Tennis": {"logo": "https://i.pinimg.com/originals/94/3a/0d/943a0d4948e42658f8608e906c27e02e.png", "keywords": ["tennis", "quần vợt", "atp", "wta", "open", "grand slam"]},
    "Bóng rổ": {"logo": "https://i.pinimg.com/originals/7b/72/70/7b7270b216f496f86c2d829983995815.png", "keywords": ["bóng rổ", "nba", "basketball"]}
}
        ...
        for m_url in list(set(matches)):
            ...
            try:
                ...
                if streams:
                    ...
                    # Bắt tên BLV và định dạng: [BLV Tên] Tên Trận
                    blv_tag = ""
                    if len(parts) > 1:
                    ...
                    for i, s in enumerate(streams):
                        s_clean = s.replace('\\', '')
                        # Link kèm header để xem mượt, không bị chặn
                        final_link = f"{s_clean}|User-Agent={quote(UA)}&Referer={quote(full_u)}"
